...
2. 출처를 명확히 밝히세요 (예: "산업안전보건법 제29조에 따르면...", "화학물질관리법 제24조에 따르면...", "별표 3에 따르면...")
...
st.markdown("산업안전, 화학물질, 환경, 위험물 관련 법규에 대해 질문하세요!")

# 사이드바
with st.sidebar:
    st.header("📚 포함된 법규")
    
    with st.expander("🔧 산업안전보건", expanded=False):
        st.markdown("""
        - 산업안전보건법
        - 산업안전보건법 시행령
        - 산업안전보건법 시행규칙
    ...
    with st.expander("🧪 화학물질", expanded=False):
        st.markdown("""
        - 화학물질관리법 (화관법)
        - 화평법 (등록 및 평가)
        - 각 시행령/시행규칙
    ...
    with st.expander("🔥 위험물/고압가스", expanded=False):
        st.markdown("""
        - 위험물안전관리법
        - 고압가스 안전관리법
        - 각 시행령/시행규칙
    ...
    with st.expander("🌿 환경", expanded=False):
        st.markdown("""
        - 대기환경보전법
        - 물환경보전법
        - 폐기물관리법
    ...
    with st.expander("📋 고시/지침", expanded=False):
        st.markdown("""
        - 위험성평가 지침
        - MSDS 기준
        - 노출기준
...
# 시스템 초기화
with st.spinner("🔄 시스템 준비 중... (처음엔 3-5분 걸릴 수 있어요)"):
